...
export class UpdateUserDto {
    ...
    static create(props: { [key: string]: any }): [string?, UpdateUserDto?] {
        const { id, firstName, lastName, username, position, secondPosition, email, password } = props
        ...
        return [undefined, new UpdateUserDto(id, firstName, lastName, username, position, secondPosition, email, password)]
    }
